workspace "OpenStat - Vues Contexte et Conteneur" "Application de reporting pour les réseaux, services voix et vidéo, et services clients." {
    ...
    model {
        ...
        openstat = softwareSystem "OpenStat" "Application de reporting pour les réseaux, services de voix et de vidéo, et services clients et opérations." {
            ...
            // === Conteneurs Internes ===
            dataview = container "OpenDataView" "Interface Web pour la visualisation des rapports." "Angular"
        ...
        emf_inventory -> proxycollector "Fournit les données d'inventaire (SALTO, GINI) [Fournisseur]."
    ...
    views {
        systemContext openstat {
            ...
            description "Cette vue illustre les acteurs externes, les systèmes interagissant avec OpenStat et leurs interactions."
        }
        ...
        container openstat {
            ...
            description "Cette vue détaille les interactions entre les conteneurs internes d'OpenStat et les systèmes externes."
        }
